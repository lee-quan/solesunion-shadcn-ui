        ...
        <div className="min-h-screen bg-[rgba(30,30,30,1) border-b-white">
            ...
            <section className="bg-[rgba(30,30,30,1)]">
                <h2 className="text-3xl font-bold text-white mb-2 py-5 flex justify-center items-center">
                    <span className="text-[100px] mr-3">5</span> Authentication
                    Points
                </h2>
                <img src="/images/AuthenticationPoints.png" />
            ...
            <section className="bg-[rgba(30,30,30,1)]">
                <h2 className="text-3xl py-5 font-bold mb-2 text-white flex justify-center items-center">
                    <span className="text-[100px] mr-3">5</span> Quality Check
                    Points
                </h2>
                <img src="/images/QualityCheckPoints.png" />
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4 p-4">
            ...
            <section className="bg-[rgba(30,30,30,1)]">
                <h2 className="text-3xl font-bold text-white mb-2 pt-5 flex justify-center items-center">
                    <span className="text-[100px] mr-3">2</span> Inspections
                    Points : <br />
                    Double Check by SU Specialists
                </h2>
                <img src="/images/InspectionPoints.jpg" />
                <div className="grid grid-cols-1 gap-4 p-4">
                    <div className="shadow-md rounded-lg p-4 bg-white">
                        <p className="text-gray-700 text-center">
                            To ensure no detail is overlooked, every sneaker
                            undergoes a rigorous double-check by our SU
                            specialists. This two-step verification process
                            guarantees the authenticity and quality of the
                            sneakers, providing peace of mind that each pair
                            meets our high standards before reaching our
                            customers
                        </p>
                    </div>
                </div>
