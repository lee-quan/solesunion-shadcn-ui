              ...
              <NavigationMenuLink asChild key={link.title}>
                <Link
                  className={cn(
                    ...
                    link.auth && !session ? "hidden" : "block"
                  )}
                  href={link.href}
                >
                  {link.title}
  ...
  return (
    <div className="bg-blue-500 py-1">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-center text-xs md:text-base text-white font-bold">
          <div className="flex items-center gap-2">
            <span>Authentic. Brand New. Protected Deliveries.</span>
          </div>
        </div>
      </div>
    </div>
